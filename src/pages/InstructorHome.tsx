  ...
  const tips = [
    {
      ...
      description: "Click on 'Dashboard' in the navigation menu, then use the 'Create New Course' button. Fill in the course details including title, description, category, and pricing.",
      steps: [
        "Navigate to Instructor Dashboard",
        "Click 'Create New Course' button",
        "Enter course title and description",
        "Set category, level, and price",
    ...
    },
    {
      ...
      steps: [
        ...
        "Price competitively based on course value"
      ]
    },
    {
      ...
      steps: [
        ...
        "Update lessons, pricing, or descriptions anytime",
        "Delete courses you no longer want to offer",
        "Monitor student enrollments (coming soon)"
      ]
    }
  ];
