        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Empowering learners and educators to share knowledge freely.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:support@learnflow.com" className="text-muted-foreground hover:text-primary smooth-transition flex items-center gap-1">
